...
public extension Passage {
    ...
    struct Contracts: Sendable {
        ...
        let passkeyGuestRegistrationForm: any PasskeyGuestRegistrationForm.Type
        ...
        public init(
            ...
            passkeyGuestRegistrationForm: (any PasskeyGuestRegistrationForm.Type)? = nil
        ) {
            ...
            self.passkeyGuestRegistrationForm = passkeyGuestRegistrationForm ?? DefaultPasskeyGuestRegistrationForm.self
        }
    }

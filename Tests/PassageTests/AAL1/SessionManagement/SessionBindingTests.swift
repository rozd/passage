...
struct `AAL1 session binding` {

    @Test(.tags(.aal1, .sessionManagement, .authenticator, .unit, .shall))
    func `§7.1-a: A session secret is shared between the subscriber and the service`() async throws {
    ...
    @Test(.tags(.aal1, .sessionManagement, .authenticator, .unit, .shall))
    func `§7.1-b: Session secret is presented directly by the subscriber on each request`() async throws {
    ...
    @Test(.tags(.aal1, .sessionManagement, .authenticator, .unit, .shall))
    func `§7.1-c: Session secret is generated by the session host in direct response to an auth event`() async throws {
    ...
    @Test(.tags(.aal1, .sessionManagement, .authenticator, .unit, .shall))
    func `§7.1-f: Session secret is generated by the session host during the post-auth interaction`() async throws {
    ...
    @Test(.tags(.aal1, .sessionManagement, .authenticator, .unit, .shall))
    func `§7.1-g: Session secret is produced by an approved RBG with at least 64 bits of entropy`() async throws {
    ...
    @Test(.tags(.aal1, .sessionManagement, .authenticator, .unit, .shall))
    func `§7.1-n: POST content carries a session identifier the RP verifies against stored state`() async throws {
